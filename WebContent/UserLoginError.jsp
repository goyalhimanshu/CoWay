        ...
        <div class="col-md-12">
            <div class="error-template">
                <div class="error-details">
                    Sorry, an error has been occurred. Your account has blocked temporarily!
                </div>
                <div class="error-actions">
                    <a href="../coway/" class="btn btn-primary btn-lg"><span class="glyphicon glyphicon-home"></span>
