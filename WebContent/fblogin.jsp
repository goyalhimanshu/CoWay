    	  ...
    	  <div class="container">
		    ...
		    <div class="collapse navbar-collapse" id="navbar-brand-centered">
		      ...
		      <ul class="nav navbar-nav navbar-right">
		        ...
		        <li><a href="#">Link</a></li>
		        <li><a href="#">Link</a></li>	
		        <li id="logintab" class=""> <button id="loginBtn" class="btn btn-info" onclick="doLogin()" style="border: 0; margin-top: 10px;" ><i class="fa fa-facebook fa-fw animated"></i>Login</button>
                </li>
...
<button type="button" class="btn btn-info" data-toggle="modal" data-target="#myModal">Offer Ride</button>
      <%@include file="assets/svg_background.html" %>    
