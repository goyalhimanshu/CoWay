  ...
  <div class="container">
	<div align="center">
		<table id="users" class="table table-hover" width="577" border="0" align="center" cellpadding="1" cellspacing="1">
    		...
    		<tbody>
			<%
				String userid="",name="",email="",age="",friend_count="", blocked="";
			...
			%>
				<tr class=''>
					...
					<%
						...
						{					
					 %>
							<td align="center"><a href="BlockUser.jsp?userid=<%=userid%>"class="btn btn-danger btn-md disabled" data-toggle="tooltip" title="Already Blocked"><span class="glyphicon glyphicon-ok"></span> Blocked</a></td>
					<%
						}
						else
						{					
					 %>
					 		<td align="center"><a href="BlockUser.jsp?userid=<%=userid%>"class="btn btn-danger btn-md" data-toggle="tooltip" title="Block the user"><span class="glyphicon glyphicon-remove"></span> Block</a></td>
					 <%
					 	}
					  %> 
